...
new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#chart-with-area", {
...
new Chartist.Bar("#overlapping-bars", data, options, responsiveOptions), new Chartist.Bar("#stacked-bar-chart", {
