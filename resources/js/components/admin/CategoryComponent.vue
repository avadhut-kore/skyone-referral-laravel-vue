            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                            <table id="manage-category-report" class="table table-striped table-bordered dt-responsive">
                                    <thead>
                                        <tr>
                                            <th>Sr.No</th>
                                            <th>Product Name</th>
        ...
        methods: {
            ...
            manageProductReport(){
                ...
                setTimeout(function(){
                    //debugger;
                    let i = 0;
                    const table = $('#manage-category-report').DataTable({
                        responsive: true,
                        ...
                        ajax: {
                            url: apiAdminHost+'category-list',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
