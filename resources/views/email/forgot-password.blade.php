        ...
        <div class="warp" style=" width: 600px; background: #fff; margin: 10px auto; display: block;">
            <div class="wrapper-inner">
                <div class="wrapper-header-bottom" style="background: #fff; padding: 10px; text-align: center;">
                    <img src="{{asset('public/images/logo.png')}}" alt="Logo" width="130">
                ...
                <div class="wrapper-body" style="background: #fff; padding: 37px; ">
                    <p style="color: #717171; margin: 10px 0; line-height: 1.6;">If you have lost your password or wish to reset it, <a href="{{$reseturl}}" style="">Click Here</a>...
                    </p>
                    <p style="color: #717171; margin: 10px 0; line-height: 1.6;">If you did not request a new password please ignore this mail. Your password will remain unchanged.</p>
