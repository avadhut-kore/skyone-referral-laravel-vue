    ...
    <div class="warp" style=" width: 600px; background: #ffe; margin: 10px auto; display: block;">
        <div class="wrapper-inner">
          ...
          <div class="wrapper-body" style="background: #fff; padding: 40px; ">
            ...
            <p style="color: #717171; margin: 10px 0; line-height: 1.6;">Your User id '.$userid.' has received a Provide help link of $'.$amount.'. <a href="'.$domain.'" style="">Click here </a> to view the receiver\'s details and send the help instantly.</p>
      ...
      <div class="wrapper-footer" style="background: #fff; padding: 10px; text-align: center;">
        <div class="copyright">
          ...
          <p> <a href="'.$domain.'" style="">'.$domain.'</a></p>
        </div>
      </div>
    </div>
  </body>
