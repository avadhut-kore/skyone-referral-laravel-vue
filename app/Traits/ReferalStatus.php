...
use Config;
// use model
use App\Models\ReferalStatus as ReferalStatusModel;
...
trait ReferalStatus {
    ...
    public function __construct(ReferalStatusModel $ref) {
    	$this->referal_status = $ref;
    }

    public function getAllReferalStatusList() {
    ...
    public function storeReferalStatus($request) {
    ...
    public function updateReferalStatus($request) {
    ...
    // public function destroyReferalStatus($request) {
	...
	public function getReferalStatusInfo($id) {
