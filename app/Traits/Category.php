...
trait Category {
    ...
    protected $category;
    public function __construct(CategoryModel $cat) {
    	$this->category = $cat;
    }
    ...
    public function getCatDetails($id) {
        ...
        $sub_cats = $this->category->where('parent_category_id',$id)->get();
    ...
    public function getSubCategoriesByCatId($category_id) {
