...
use Config;
// use model
use App\Models\Referal as ReferalModel;
...
trait Referal {
    ...
    protected $referal;
    public function __construct(ReferalModel $ref) {
        $this->referal = $ref;
    }

    public function getAllReferals() {
    ...
    public function storeReferal($request) {
    ...
    public function updateReferal($request) {
 ...
 //    public function destroyReferal($request) {
 ...
 //        $this->referal->referal_status()->detach();
    ...
    public function getReferalInfo($id) {
